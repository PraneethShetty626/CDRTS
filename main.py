...
def start_processing(video_path=None):
    ...
    while(True):
        ...
        for _, (*xyxy, _, _) in enumerate(reversed(detections)):
            save_one_box(xyxy=xyxy,im=frame,c=c,fc=fc,gain=3,pad=20,square=True)
            c=c+1
...
if __name__== '__main__':
    ...
    start_processing(video_path=r'E:\Major_Project\Datasets_zip\Normal_Videos_for_Event_Recognition\Normal_Videos_for_Event_Recognition\Normal_Videos_312_x264.mp4')
